...
class ProductCrud(CreateMixin,DeleteMixin,ReadMixin,UpdateMixin):
    objects = {}
    _id = 1

crud = ProductCrud()
crud.product_create('Samsung',230)
crud.product_create('Iphone',100)
#crud.product_detail(1)
#crud.product_detail(2)
crud.delete_product(2)
crud.product_detail(1)
#crud.product_update(2,"Iphone",122)
#crud.product_detail(2)